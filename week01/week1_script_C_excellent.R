...
**Strengths of Script C**:
- Clear, extensive comments explaining purpose and logic
- Correct calculations (throughput excludes labor)
- Professional structure with clear sections
- Meaningful variable names
- Comprehensive interpretation
- Formatted output that's easy to read
- Identifies the key insight (efficiency paradox)
- Provides actionable recommendations
- Saves results for future use

---

## **Class Discussion Guide for Evaluation Activity**

### **Activity Structure** (30-40 minutes)

**Part 1: Individual Review (10 minutes)**
- Give students all three scripts
- Ask them to run each script and examine the outputs
- Have them identify differences in:
  - Code quality
  - Results (numbers)
  - Ease of understanding

**Part 2: Small Group Discussion (10 minutes)**
Groups of 3-4 discuss:
- Which script is easiest to understand? Why?
- Which script has correct calculations? How do you know?
- Which script would you want to receive if you were Alex?

**Part 3: Class Discussion (15-20 minutes)**

**Question 1**: "Let's start with Script A. It works—it produces output. What's wrong with it?"

**Expected Student Responses**:
- Hard to understand what's happening
- Variable names don't mean anything (x, y, d)
- No comments
- Informal interpretation

**Teaching Point**: "In industry, code isn't just for computers—it's communication with other humans. You might work on this code 6 months from now and forget what you were thinking. Or someone else might need to modify it. Professional code is readable code."

**Question 2**: "Now Script B. It looks professional—good comments, clear structure. But there's a problem. Can anyone spot it?"

**Expected Discovery Process**:
- Students compare numbers between Script B and Script C
- Throughput values are different
- Guide them to the calculation if needed

**Teaching Point**: "Look at line [X] in Script B. It includes labor_costs in the throughput calculation. Why is this wrong?"

**Key Concept to Emphasize**:
- Throughput = Sales - Truly variable costs
- Truly variable = varies with EACH UNIT (materials)
- Labor doesn't vary per unit (you pay workers whether they make 100 units or 1000)
- This isn't just an academic distinction—it changes the decisions you'd make
- If throughput looks lower than it is, you might cut the wrong costs

**Question 3**: "What makes Script C excellent?"
...
**Teaching Point**: "This is the standard we're aiming for. Your code should be something you'd be proud to show a manager or include in your portfolio. Notice also that Script C doesn't just calculate numbers—it tells a story and provides recommendations. That's what analysts do."

**Question 4**: "Look at Script C's output about the Efficiency Paradox. What's happening at UniCo?"

**Expected Responses**:
- Efficiency going up (87% → 95%)
- But throughput going down
- Inventory going up
- Making more but selling less

**Teaching Point**: "This is exactly what Alex is discovering in The Goal. The plant looks more efficient by traditional metrics, but it's actually performing worse. This is why we need Theory of Constraints thinking—local optimization doesn't guarantee global optimization."
...
│   ├── script_A_poor.R
│   ├── script_B_error.R
│   └── script_C_excellent.R
├── template/
│   └── week1_template.R  (optional starter template)
└── README.txt
```

**README.txt**:
```
WEEK 1 ASSIGNMENT: Financial Analysis for Alex Rogo

SCENARIO:
You're a new Supply Chain Intern at UniCo Manufacturing. The plant is 
in crisis and Alex Rogo needs to understand the plant's true financial 
performance using Theory of Constraints metrics.

YOUR TASK:
Create an R script that calculates Throughput, Inventory, and Operating 
Expense from the provided data files. Analyze trends and provide 
interpretation.

DATA FILES (in /data folder):
- financial_data.csv: Revenue and cost data (6 months)
- inventory_levels.csv: Inventory levels (6 months)
- production_output.csv: Traditional metrics for comparison

DELIVERABLE:
Submit an R script (.R file) with:
1. Code that reads data and calculates metrics
2. Summary table showing T, I, OE, NP, ROI for each month
3. Written interpretation (4-6 sentences)
4. Professional formatting and comments

DUE: [Date]

EVALUATION ACTIVITY:
Before starting your assignment, review the three example scripts in 
the /evaluation_examples folder. Run each one and note the differences 
in quality, correctness, and professionalism. We'll discuss these in class.

TIPS:
- Read Chapters 1-5 of The Goal for context
- Remember: Throughput = Sales - Truly Variable Costs (materials ONLY)
- Operating Expense = All other costs (including labor)
- Use the template file as a starting point if helpful
